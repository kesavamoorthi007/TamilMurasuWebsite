...
{
	public class SportNewsDetailService : ISportNewsDetailService
	{
		private readonly string _connectionString;
		public SportNewsDetailService(IConfiguration _configuratio)
		{
			_connectionString = _configuratio.GetConnectionString("MySqlConnection");
		}
		public DataTable GetSportNewsDeatils()
		{
